...
public class Carro extends Veiculo {
	...
	Motor motor, String tipocambio, String arosRodas, double velocidade, Condutor condutor, boolean ligado,
	Carga carga, int eixos,double capacidadeDeRodagem,double capacidadeDoTanque) {
		super(marca, modelo, cor, anofabrica, anoModelo, renavam, motor, tipocambio, arosRodas, velocidade, condutor,
		ligado, capacidadeDoTanque);
		this.capacidadeDeRodagem = capacidadeDeRodagem;	
	}
